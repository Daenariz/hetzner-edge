...
zfs create -o mountpoint=legacy dpool/data/gitlab
...
zfs create -o mountpoint=legacy dpool/data/maubot
zfs create -o mountpoint=legacy dpool/data/minecraft
...
mount -o X-mount.mkdir -t zfs dpool/data/gitlab         "$MNT"/data/gitlab
...
mount -o X-mount.mkdir -t zfs dpool/data/maubot         "$MNT"/data/maubot
mount -o X-mount.mkdir -t zfs dpool/data/minecraft      "$MNT"/data/minecraft
